...
export default function IngredientEdit({ ingredient }) {
  return (
    <tr>
      <td className="w-[45%]">
        <input type="text" className="form-input w-full mb-1" value={ingredient.name}></input>
      </td>
      <td className="w-[45%]">
        <input type="text" className="form-input w-full mb-1" value={ingredient.amount}></input>
      </td>
